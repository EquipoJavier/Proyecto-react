...
export default function SectionTransportVoucher() {
  return (
    <section className="section__transportVoucher">
      ...
      <a href="#voucher"><h1 className="section__transportVoucher--h1-subtitle"><i className="material-icons arrow">arrow_forward</i>¡Para hacerte con la tuya pulsa aquí!<i className="material-icons arrow">arrow_back</i></h1></a>
    </section>
  )
}
